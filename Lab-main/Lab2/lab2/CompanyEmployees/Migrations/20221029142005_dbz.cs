...
{
    public partial class dbz : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Animals",
                columns: new[] { "AnimalId", "AnimalName", "WeightKg" },
                values: new object[,]
                {
                    { 1, "Кот", 14 },
                    { 2, "Собака", 3 }
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Cost", "NameProduct", "Quantity" },
                values: new object[,]
                {
                    { 1, 100, "Носки", 4 },
                    { 2, 400, "Шапка", 5 }
